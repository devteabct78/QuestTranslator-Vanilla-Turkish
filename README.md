...
NOT: Eğer NPC ye tıkladığınızda görev çeviri ekranı gelmiyorsa QuestLogdaki göreve tıklayıp tekrar npc tıklarsanız düzeliyor. Malesef api kısıtından dolayı bunu düzeltemedim.
